...
// Register creates a service record in registry.
...
// Deregister remove a service record from the registry.
...
// ServiceAddresses returns the list of addresses of active instaces of the given service.
